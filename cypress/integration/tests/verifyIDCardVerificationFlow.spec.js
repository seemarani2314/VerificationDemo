...
describe('Happy Path Flow - ID CARD', function () {

    it('Verify ID CARD Verification Flow', function () {
        cy.fixture('verificationData').then((payload) => {
            ...
            homePage.enterDocumentType().should('contain', payload.id_card)
